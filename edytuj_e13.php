...
<body>
	...
	<div class="col-md-7 center-block" >
		<h3> <a href="e13.php" class="links_not_important">Technik informatyk - kwalifikacja E13</a> </h3>
		<?php
			...
			while($r = mysqli_fetch_array($zapytanie_e13))
			{
				...
				echo "<input type='text' name='tabela' value='e13' style='visibility:hidden' /><br>";
