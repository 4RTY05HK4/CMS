...
<body>
	...
	<div class="col-md-7 center-block" >
		...
		<?php
			...
			$zapytanie_e13 = mysqli_query($p, 'SELECT * FROM e13');

			while($r = mysqli_fetch_array($zapytanie_e13))
			{
				echo '<br><h3>'.$r['Wpis'].'</h3><p>Data:'.$r['Data'].'</p>';
				$data = $r['Data'];
				$name_e13 = $r['IDwpis'];
				echo "<form action='e13.php' method='post'>";
				echo "<input type='text' name='$name_e13' value='$data' style='visibility:hidden' /><br>";
				echo "<input type='submit' name='usun_z_e13' value='usuń wpis' class='btn btn-danger' />";
				echo "</form>";
				if(isset($_POST[$name_e13])  && isset($_POST['usun_z_e13'])){
					$sql_e13_2 = 'DELETE FROM e13 WHERE IDwpis='.$name_e13.';';
					$zapytanie_e13_2 = mysqli_query($p, $sql_e13_2);
